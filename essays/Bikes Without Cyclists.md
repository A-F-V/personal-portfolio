...
slug: bikes-without-cyclists
publish_date: 2026-03-05
draft: false
canonical_url: https://alessandrofv.substack.com/p/bikes-without-cyclists
---
![Generated Image](https://substackcdn.com/image/fetch/$s_!bFGu!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9e637dd1-8ee8-4cf0-9c2d-a4d8f332662e_1371x768.png)

AI has got me concerned that we've stopped learning how to ride bicycles. Not a literal bicycle but a symbolic bicycle. Bicycles let us move faster than any animal while relying on nothing other than our own motor input. Any tool that amplifies our abilities is a bicycle. A computer is a ["bicycle for the mind"](https://www.themarginalian.org/2011/12/21/steve-jobs-bicycle-for-the-mind-1990/), so is language and books.
...
![Airbnb co-founders during their YC batch, Winter 2009: Brian Chesky, Joe Gebbia, and Nathan Blecharczyk](https://substackcdn.com/image/fetch/$s_!WMay!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbefa409d-9464-4eb3-b2b0-2e8f29fcce19_900x601.jpeg "Airbnb co-founders during their YC batch (Winter 2009): Brian Chesky, Joe Gebbia, and Nathan Blecharczyk")
...
I am already. My title as a software engineer now resembles a "manager of junior coders". With tools like [Conductor](https://www.conductor.build/), [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview), [Cursor](https://cursor.com/) and [Codex](https://openai.com/index/introducing-codex/), a great deal of my time is spent in an inbox, spinning up self-contained environments for the AI agents to execute my plans.
...
![Codex, OpenAI's agent orchestration interface for developers.](https://substackcdn.com/image/fetch/$s_!MG-n!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa93dbd16-9c7d-4a8d-a073-bf5077aeb686_5002x2814.webp "Codex, OpenAI's agent orchestration interface for developers.")
...
Automation will get you close but never to 100%. In building [Janus](https://janus.cards), I've had to face many problems that exceeded my skill set. Sometimes it was within reach of AI (such as designing elegant user interfaces), and in other cases was AI-unsolvable.
...
My protocol for learning this, which I will go into detail in another post, involves following a set of high priority questions until I become satisfied with my new understanding. In a few hours of inquiry, I had uncovered the misconception in my understanding, been able to trace the flow and mechanics of the problem, wrote a targeted solution [(remarkably only a single line config change)](https://supabase.com/docs/guides/database/postgres/timeouts#role-level), added additional observation to track the issue going forward, and deployed.

![Snippet from my Socratic discusions with Claude Code](https://substackcdn.com/image/fetch/$s_!8xDn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa6552844-aaba-48b1-a9c4-e5dcf4ef57e4_1842x1498.png "Snippet from my Socratic discusions with Claude Code")

![After fixing, the max number of connections is a lot more predictable!](https://substackcdn.com/image/fetch/$s_!Xt0p!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3066e813-1418-44b7-a884-8574d82ccca1_1014x308.png "After fixing, the max number of connections is a lot more predictable!")
...
This is closest to the original advice Bainbridge gave for addressing the atrophy of operator skills. Her work drew from [control theory](https://en.wikipedia.org/wiki/Control_theory) where the operator's proficiency is measured by how smoothly and accurately they can set the knobs on the machinery. Her main solution to regain an rich internal model is to reintroduce manual operation back into the process. By forcing a step in the process to be manual, I'm trying to keep my code critic taste buds sharp.
