...
- A declaration may also be flagged as `!important` (and if not marked, is then considered _normal_)
...
![origin, importance and layer](https://mdn.github.io/shared-assets/images/diagrams/css/at-rules/layer-cascade.svg)
...
- `0 5 1` > `0 2 3` because they differ in the second column and 5 > 3
- `1 0 1` > `0 10 0` because they differ in the first column and 1 > 0
