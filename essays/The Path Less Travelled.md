...
![Conclave Review — 'Pulpy and pensive in equal measure.'](https://substackcdn.com/image/fetch/$s_!cYc1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcc214efc-fcaf-4760-a6fa-e38cf038d6d8_1600x900.jpeg "Conclave Review — 'Pulpy and pensive in equal measure.'")
...
The results of each round of voting during Conclave get announced. If the pope has not been elected, the round instead has served as an initial polling of where everyone stands. In the film, there are at least 4 real contenders for the empty throne, each with pretty even initial support. That means between the poll and the final round, almost 50% of voters need to change their minds. Contrast this to the US presidential election. [Polls typically estimate that under 15% of voters are undecided going into the final weeks](https://www.axios.com/2024/10/11/harris-trump-undecided-voters-2024). That makes it challenging to predict who the fictional next pope will be, [not something I would wager $50 million on.](https://www.google.com/search?q=theo+french+voter&client=firefox-b-d&sca_esv=b36f0451ab2e42e6&ei=CvhmZ5qfPIywhbIP3auySQ&ved=0ahUKEwiazNbyrrmKAxUMWEEAHd2VLAkQ4dUDCBA&uact=5&oq=theo+french+voter&gs_lp=_iAQ&sclient=gws-wiz-serp)
...
![Margin Call" (2011) — Jeremy Irons, Kevin Spacey, Simon Baker, Zachary  Quinto, Demi Moore (1080p) - YouTube](https://substackcdn.com/image/fetch/$s_!KB3B!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24bb7392-5843-4839-8437-9ac0dfd1a03a_640x480.jpeg "Margin Call\" (2011) — Jeremy Irons, Kevin Spacey, Simon Baker, Zachary  Quinto, Demi Moore (1080p) - YouTube")
...
_Do not infer that because an option is unfavorable at one moment it will remain unfavorable forever._ There are many circumstantial factors for why it failed the first time round that may cease to be the case in the future:
...
This **first kind of patience is about waiting for the right time to take action**. There is a **second kind of patience that comes from perseverance and consistent practice**. [Steve Martin's great wisdom of "being so good they can't ignore"](https://www.youtube.com/watch?v=jTdXqsrs4oI&themeRefresh=1) requires extreme commitment. You need to persist at one specific craft over many years, something that few have the grit or willingness to do. Not only is the journey often solitary and monk-like, but so is the destination. The pack gets thin the closer you are to the top, and there aren't many that can relate to your story.
### The Brave
...
![Asch conformity experiments - Wikipedia](https://substackcdn.com/image/fetch/$s_!SiSj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc9fcc756-2b86-4ecf-a0ae-a4458d884ade_270x222.png "Asch conformity experiments - Wikipedia")
...
- **The Observant Analyst:** They were the kid in school that always asked the question 'but why?' to every answer the teacher gave, until the teacher gave up; they were still unsatisfied. They question everything and are restless truth seekers. When they find that the evidence does not accord with what people are saying, they become whistleblowers to the conspiracy. Examples: Michael Burry, Bob Woodward, and Carl Bernstein, Copernicus
    ![Who Is Michael Burry?](https://substackcdn.com/image/fetch/$s_!ZZHb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F868518a2-2228-4fc1-9637-2172c53b4ad3_1024x663.jpeg "Who Is Michael Burry?")
